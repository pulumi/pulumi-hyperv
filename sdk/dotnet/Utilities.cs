...
namespace Pulumi.Hyperv
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Hyperv.version.txt");
    ...
    internal sealed class HypervResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public HypervResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
