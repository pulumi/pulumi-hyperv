...
// Export members:
export { NetworkAdapterArgs } from "./networkAdapter";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "hyperv:networkadapter:NetworkAdapter":
...
pulumi.runtime.registerResourceModule("hyperv", "networkadapter", _module)
