...
package com.pulumi.hyperv.networkadapter.inputs;
...
public final class NetworkAdapterInputsArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkAdapterInputsArgs Empty = new NetworkAdapterInputsArgs();
    ...
    private NetworkAdapterInputsArgs() {}

    private NetworkAdapterInputsArgs(NetworkAdapterInputsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
    ...
    public static Builder builder(NetworkAdapterInputsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkAdapterInputsArgs();
        }

        public Builder(NetworkAdapterInputsArgs defaults) {
            $ = new NetworkAdapterInputsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworkAdapterInputsArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("NetworkAdapterInputsArgs", "name");
            }
            if ($.switchName == null) {
                throw new MissingRequiredPropertyException("NetworkAdapterInputsArgs", "switchName");
            }
            return $;
        }
    }
